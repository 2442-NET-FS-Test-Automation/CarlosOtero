//For demo sake, let's write a generic
//I want to create a shelf, and a shelf can hold anything
//I don't want to be limited to LibraryItems, Icam put like computer hardware or supplies on the shelf
...
public class Shelf<T>
{
    ...
    private int used; //As things are added to my array, the shelf track how slots of the shelf are being used
    //internally here
...
//Exposing some array properties as needed
    ...
    public bool TryAdd(T item)
    {
        ...
        //If the shelf isn't full then... Access the _slots array's index of the current used + 1 increment used
