...
//I can now stretch it's class definition across multiple files - when I build, all the content from all the files is stitched back together
public partial class Catalog
{
    ...
    */
    ...
    // HASHSET<T>: Unique values, 0(1) lookup. Adding a duplicate silently fails.
