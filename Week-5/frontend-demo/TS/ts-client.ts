...
// next week we'll use Axios to do this - as it comes with a lot more functionality
// but it let's us see TS classes
...
// This is an exmple of a type guard. The compiler knows about our  types - the runtime doesn't
...
// that if this function returns a "true" - the value that was passed in shoould
...
export class ApiClient {
    ...
    constructor(private readonly baseUrl: string = "http://localhost:5174") {}
    ...
    async getJson<T>(path: string): Promise<T | ApiError> {
        ...
        try {
            ...
            // Is err of type Error? If it is log its message. therwise - idk how did that.
