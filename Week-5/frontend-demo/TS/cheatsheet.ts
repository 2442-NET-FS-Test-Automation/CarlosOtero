...
// from other .TS files. This syntax will come up A LOT in react.
...
let name = "jon"; // I actually don't strickly need the type annotation
...
// Let's mix some types and also introduce tuples

// Labled tuple, fixed length, fixed element types
type PriceRange = [min:number, max:number];

// Let's use those types we imported
