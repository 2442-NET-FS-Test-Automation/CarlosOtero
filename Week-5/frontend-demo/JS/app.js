...
// The same catalog shape js/ap.js renders - and GET /api/Inventory returns
// let catalogItems = [
...
async function LoadCatalog(){
    ...
    // We've been usiing .innerHTML, this lets us swap out an elements innerHTML wholesale
    ...
    try{
        ...
        // We nee to make sure we got a 200-family code back
        if (!response.ok){
        ...
        // Fetch doesn't throw error for 400/500s. This is for stuff like
...
function renderCards(items){
    // In JS the HTML page that the JS is runnning against is treated as an object
    // called the DOM
    ...
    container.innerHTML = items.map(item => `
            <article class="card" data-sku"${item.sku}">
                ...
                <dl>
                    ...
                    <dt>In Stock</dt>${item.currentStock}<dd></dd>
                </dl>
