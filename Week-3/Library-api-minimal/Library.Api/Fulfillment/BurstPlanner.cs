...
public class BurstPlanner
{
    ...
    public IReadOnlyList<int> OrderByPriority(IEnumerable<Order> orders)
    {
        ...
        // The list will hold everything we want to process already inn order to pass to our other methods
        ...
        return orderedByPriority; // expedited id's should be first in the list
    }
}